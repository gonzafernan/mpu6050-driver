...
{
    if (HAL_I2C_Mem_Read(&hi2c1, slave_address, reg_address, sizeof(uint8_t), pdata, sizeof(uint8_t), I2C_READ_TIMEOUT) != HAL_OK) return MPU6050_ERROR;
    return MPU6050_OK;
}
...
{
    if (HAL_I2C_Mem_Read(&hi2c1, slave_address, reg_address, sizeof(uint8_t), pdata, sizeof(uint8_t)*data_amont, I2C_READ_TIMEOUT) != HAL_OK) return MPU6050_ERROR;
    return MPU6050_OK;
}
...
{
    if (HAL_I2C_Mem_Write(&hi2c1, slave_address, reg_address, sizeof(uint8_t), pdata, sizeof(uint8_t), I2C_WRITE_TIMEOUT) != HAL_OK) return MPU6050_ERROR;
    return MPU6050_OK;
}
