 ...
 * @retval  mpu6050_status_t
*/
static mpu6050_status_t mpu6050_burst_read(uint8_t reg_address, uint8_t* pdata, uint16_t data_amount)
{
    /* MPU6050 register read wrapper */
 ...
 * @retval  mpu6050_status_t
*/
static mpu6050_status_t mpu6050_nonblocking_read(uint8_t reg_address, uint8_t* pdata, uint16_t data_amount)
{
...
{
    uint8_t reg_value;
    if (mpu6050_gyro_read_config(&reg_value) != MPU6050_OK) return MPU6050_ERROR;
...
{
    uint8_t reg_value;
    if (mpu6050_accel_read_config(&reg_value) != MPU6050_OK) return MPU6050_ERROR;
