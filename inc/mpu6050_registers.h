...
/**
 * @brief When asserted the i2c_master interface pins will go into bypass mode when the i2c master
 * interface is disabled The pins will float high due to the internal pull-up if not enabled and the
